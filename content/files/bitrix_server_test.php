<?php
#####################################
define('LAST_MODIFIED','09.10.2017');
#####################################
...
if ($lang=='en')
{
	...
	$M['PHP_VER_DESC']='Required version: 5.6 and higher, version 7.1 is recommended'; 
...
else
{
	...
	$M['PHP_VER_DESC']='Требуется 5.6 и выше, рекомендуется 7.1';
...
show($pr,phpversion(),version_compare(phpversion(),'5.6.0','<'));
